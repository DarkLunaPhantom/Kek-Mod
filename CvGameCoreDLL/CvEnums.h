...
enum GameOptionTypes				// Exposed to Python
{
    ...
    GAMEOPTION_ADVANCED_SETTLERS, // DarkLunaPhantom - Added Advanced Settlers game option.
    ...
    GAMEOPTION_UNLIMITED_PERMANENT_ALLIANCES, // DarkLunaPhantom - Added Unlimited Permanent Alliances game option.
