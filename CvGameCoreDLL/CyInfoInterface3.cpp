...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvProjectInfo, python::bases<CvInfoBase> >("CvProjectInfo")
		...
		.def("getMaxTeamInstances", &CvProjectInfo::getMaxTeamInstances, "int (int i)")
		...
		.def("getVictoryThreshold", &CvProjectInfo::getVictoryThreshold, "int (int i, int j)")
		.def("getVictoryMinThreshold", &CvProjectInfo::getVictoryMinThreshold, "int (int i, int j)")
