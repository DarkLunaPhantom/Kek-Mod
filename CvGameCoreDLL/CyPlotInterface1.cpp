...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("canHaveImprovement", &CyPlot::canHaveImprovement, "bool (int (ImprovementTypes) eImprovement, int (TeamTypes) eTeam, bool bPotential, int (BuilTypes) eBuild, bool bAnyBuild)") // DarkLunaPhantom
