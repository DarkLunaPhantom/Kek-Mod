...
*/
	...
	python::enum_<WorldSizeTypes>("WorldSizeTypes")
		...
		.value("WORLDSIZE_GIGANTIC", WORLDSIZE_GIGANTIC) // DarkLunaPhantom
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_ADVANCED_SETTLERS", GAMEOPTION_ADVANCED_SETTLERS) // DarkLunaPhantom - Added Advanced Settlers game option.
		...
		.value("GAMEOPTION_DUMMY", GAMEOPTION_DUMMY) // DarkLunaPhantom - This should always be in the 8th spot. (cf. with CvInitCore::getOption)
		...
		.value("GAMEOPTION_UNLIMITED_PERMANENT_ALLIANCES", GAMEOPTION_UNLIMITED_PERMANENT_ALLIANCES) // DarkLunaPhantom - Added Unlimited Permanent Alliances game option.
	...
	python::enum_<AdvancedStartActionTypes>("AdvancedStartActionTypes")
		...
		.value("ADVANCEDSTARTACTION_NOOP", ADVANCEDSTARTACTION_NOOP)
