...
public:
	...
	bool canHaveImprovement(ImprovementTypes eImprovement, TeamTypes eTeam = NO_TEAM, bool bPotential = false, BuildTypes eBuild = NO_BUILD, bool bAnyBuild = false) const; // DarkLunaPhantom		// Exposed to Python
